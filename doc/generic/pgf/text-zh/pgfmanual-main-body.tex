...
\newbox\mybox
{
  ...
  \begin{tikzpicture}[overlay]
    ...
    \node [at={( 0,0  )}] {\large\href{https://github.com/rnicrosoft-studio/pgf-tikz-manual-chinese}{\texttt{https://github.com/rnicrosoft-studio/pgf-tikz-manual-chinese}}};
