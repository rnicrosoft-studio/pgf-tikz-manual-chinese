...
\newbox\mybox
{
  ...
  \begin{tikzpicture}[overlay]
    ...
    \nodeshadowed [at={( 0,2  )}] {\pgftypesetversion 版本 使用手册};
    \node [at={( 0,0  )}] {\large 中文翻译：\href{https://github.com/rnicrosoft-studio/pgf-tikz-manual-chinese}{\texttt{https://github.com/rnicrosoft-studio/pgf-tikz-manual-chinese}}};
...

{
  ...
  献给我的父亲，这样他就能创造出更多漂亮的 \TeX 图形。\footnote{译注：德语}
  \vskip1em
  \hfill\emph{Till}
  \vskip0pt plus 3fill
...
\title{\bfseries \tikzname\ 及 {\Large PGF} 宏包\\
  \large \pgfversion  版本 使用手册\\[1mm]
...
\author{Till Tantau\footnote{Editor of this documentation. Parts of
  ...
  \large 中文翻译：\href{https://github.com/rnicrosoft-studio/pgf-tikz-manual-chinese}{\texttt{https://github.com/rnicrosoft-studio/pgf-tikz-manual-chinese}}}
...
\part{教程和指南 Tutorials and Guidelines}
...
\include{pgfmanual-tutorial-nodes}
\include{pgfmanual-tutorial-Euclid}
\include{pgfmanual-tutorial-chains}
\include{pgfmanual-tutorial-map}
\include{pgfmanual-guidelines}



\part{安装和配置 Installation and Configuration}
...
\include{pgfmanual-license}
\include{pgfmanual-drivers}



\part{Ti\emph{k}Z 不是绘图程序 Ti\emph{k}Z ist \emph{kein} Zeichenprogramm}\footnote{译注：德语}
\label{part-tikz}
...
\include{pgfmanual-tikz-arrows}
\include{pgfmanual-tikz-shapes}
\include{pgfmanual-tikz-pics}
\include{pgfmanual-tikz-graphs}
\include{pgfmanual-tikz-matrices}
\include{pgfmanual-tikz-trees}
\include{pgfmanual-tikz-plots}
\include{pgfmanual-tikz-transparency}
\include{pgfmanual-tikz-decorations}
\include{pgfmanual-tikz-transformations}
\include{pgfmanual-tikz-animations}



\part{图的绘制 Graph Drawing}
\label{part-gd}
...
\include{pgfmanual-gd-overview}
\include{pgfmanual-gd-usage-tikz}
\include{pgfmanual-gd-usage-pgf}
\include{pgfmanual-gd-trees}
\include{pgfmanual-gd-layered}
\include{pgfmanual-gd-force}
\include{pgfmanual-gd-circular}
\include{pgfmanual-gd-phylogenetics}
\include{pgfmanual-gd-edge-routing}
%
% XXX : disabled because of
% 1. compile-time dependencies which are hard to resolve
% 2. it is "hardly usable anyway" (TT)
%\include{pgfmanual-gd-ogdf}
\include{pgfmanual-gd-algorithm-layer}
\include{pgfmanual-gd-algorithms-in-c}
\include{pgfmanual-gd-display-layer}
\include{pgfmanual-gd-binding-layer}
...
\include{pgfmanual-library-3d}
\include{pgfmanual-library-angles}
\include{pgfmanual-library-arrows}
\include{pgfmanual-library-automata}
\include{pgfmanual-library-babel}
\include{pgfmanual-library-backgrounds}
\include{pgfmanual-library-calc}
\include{pgfmanual-library-calendar}
\include{pgfmanual-library-chains}
\include{pgfmanual-library-circuits}
\include{pgfmanual-library-decorations}
\include{pgfmanual-library-er}
\include{pgfmanual-library-external}
\include{pgfmanual-library-fadings}
\include{pgfmanual-library-fit}
\include{pgfmanual-library-fixedpoint}
\include{pgfmanual-library-fpu}
\include{pgfmanual-library-lsystems}
\include{pgfmanual-library-math}
\include{pgfmanual-library-matrices}
\include{pgfmanual-library-mindmaps}
\include{pgfmanual-library-folding}
\include{pgfmanual-library-patterns}
\include{pgfmanual-library-perspective}
\include{pgfmanual-library-petri}
\include{pgfmanual-library-plot-handlers}
\include{pgfmanual-library-plot-marks}
\include{pgfmanual-library-profiler}
\include{pgfmanual-library-rdf}
\include{pgfmanual-library-shadings}
\include{pgfmanual-library-shadows}
\include{pgfmanual-library-shapes}
\include{pgfmanual-library-spy}
\include{pgfmanual-library-svg-path}
\include{pgfmanual-library-edges}
\include{pgfmanual-library-through}
\include{pgfmanual-library-trees}
\include{pgfmanual-library-turtle}
\include{pgfmanual-library-views}



\part{数据可视化 Data Visualization}
\label{part-dv}
...
\include{pgfmanual-dv-introduction}
\include{pgfmanual-dv-main}
\include{pgfmanual-dv-formats}
\include{pgfmanual-dv-axes}
\include{pgfmanual-dv-visualizers}
\include{pgfmanual-dv-stylesheets}
\include{pgfmanual-dv-polar}
\include{pgfmanual-dv-backend}
...
\include{pgfmanual-pgfkeys}
\include{pgfmanual-pgffor}
\include{pgfmanual-pgfcalendar}
\include{pgfmanual-pages}
\include{pgfmanual-xxcolor}
\include{pgfmanual-module-parser}



\part{数学和面向对象引擎 Mathematical and Object-Oriented Engines}
...
\include{pgfmanual-math-design}
\include{pgfmanual-math-parsing}
\include{pgfmanual-math-commands}
\include{pgfmanual-math-algorithms}
\include{pgfmanual-math-numberprinting}
\include{pgfmanual-oo}



\part{基础层 The Basic Layer}
...
\include{pgfmanual-pgfsys-animations}



\part{引用和索引 References and Index}
